      ...
      <Row className="justify-content-md-center mt-5">
        ...
        <Col md={6}>
          ...
          >
            ...
            >
              <Form.Label className="text-gray-500">Description</Form.Label>
              <Form.Control
                name="description"
                required
                as="textarea"
            ...
            <Form.Group className="mb-3" controlId="formBasicCount">
              <Form.Label className="text-gray-500">Count in stock</Form.Label>
              <Form.Control
                name="count"
                required
                type="number"
            ...
            <Form.Group className="mb-3" controlId="formBasicPrice">
              <Form.Label className="text-gray-500">Price</Form.Label>
              <Form.Control
                name="price"
                required
                type="text"
            ...
            <Form.Group className="mb-3" controlId="formBasicCategory">
              <Form.Label className="text-gray-500">Category</Form.Label>
              <Form.Select
                required
                name="category"
            ...
            <Form.Group controlId="formFileMultiple" className="mb-3 mt-3">
              <Form.Label className="text-gray-500">Images</Form.Label>
              <Row>
                {product.images &&
